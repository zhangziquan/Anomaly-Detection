...
class Trainer(object):
    ...
    def train(self):
        ...
        for real, _ in self.dataloader:
            ...
            loss_e = self.loss_fn(real, fake) + 2*self.loss_fn(recon_features, image_features)
    ...
    def test(self):
        ...
        with torch.no_grad():
            ...
            for (x, label) in self.testdataloader:
                ...
                z_distance = loss_fts
                img_distance2 = img_distance + 2*loss_fts
    ...
    def save_reconstruct(self, filename):
        ...
        with torch.no_grad():
            for real, i in self.dataloader:
                ...
                save_image(real.data, 'reconstruction3/original'+str(index)+'.jpg', normalize=True)